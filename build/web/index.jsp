...
<html>
    <head>
        <title>Students Inventory Application</title>
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-md navbar-dark" style="background-color: blue">
                <div></div>
                <ul class="navbar-nav">
                    <li><a href="<%=request.getContextPath()%>/list" class="nav-link">Students Available</a></li>
                </ul>
            </nav>
        </header>
        <br>
        <div class="row">
            <div class="container">
                ...
                <div class="container text-left">
                    <a href="<%=request.getContextPath()%>/new" class="btn btn-success">Add New Students</a>
                </div>
                <br>
